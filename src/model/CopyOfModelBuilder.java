...
public class CopyOfModelBuilder {
	/*
	...
	public CopyOfModelBuilder(double eps, double C, SimpleMatrix dataMatrix)
	{
		/*
		 * Constructor.
	...
	public static void main(String args[])
	{
		...
		CopyOfModelBuilder trainer = new CopyOfModelBuilder(0.01,0.01, dataMatrix);
