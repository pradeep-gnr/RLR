...
public class Copy_2_of_Logistic {
    ...
    public Copy_2_of_Logistic (double rate, double C, SimpleMatrix dataMatrix)
    {
        this.rate = rate;        
        this.C=C;
        this.eps = 0.0001;
    ...
    public static void main(String... args) throws FileNotFoundException {
    	...
    	//dataMatrix.print();
		Copy_2_of_Logistic trainer = new Copy_2_of_Logistic(0.01,0.01, dataMatrix);
		trainer.train();
